...
pub fn bench_x25519_shared_key(c: &mut Criterion) {
    ...
    group.bench_function("x25519_shared_key_dalek", |b| {
        let public_key = x25519_dalek::PublicKey::from(&x25519_dalek::StaticSecret::random_from_rng(OsRng));
    ...
    group.bench_function("x25519_shared_key_ring", |b| {
        ...
        let my_public_key = ring::agreement::UnparsedPublicKey::new(peer_public_key_alg, &peer_public_key);
