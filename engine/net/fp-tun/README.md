...
> Fork from tun & wintun.

cross-platform tun lib.

## Supported platforms

| Target triple                 | Library |
| ----------------------------- | ------- |
...
TUN interfaces [![Crates.io](https://img.shields.io/crates/v/tun.svg)](https://crates.io/crates/tun) ![tun](https://docs.rs/tun/badge.svg)
==============
...
```toml
[dependencies]
tun = { version = "0.0.1", features = ["async"] }
```
